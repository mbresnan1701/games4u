  ...
  $scope.signin = function () {
    $http({
      ...
      headers: {'Content-Type': 'application/json;charset=utf-8'}
        ...
        $window.localStorage.setItem('com.g4uUser', JSON.stringify({username: data.username, gamesStr: data.gamesStr, userGames: []}));
  ...
  $scope.signup = function () {
    $http({
          ...
          headers: {'Content-Type': 'application/json;charset=utf-8'}
            ...
            $window.localStorage.setItem('com.g4uUser', JSON.stringify({username: data.username, gamesStr: '', userGames: []}));
            $location.path('/mygames');
        })
  };
